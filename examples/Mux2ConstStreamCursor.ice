{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "4178e74d-6477-46c8-bb4f-17c6e372d757",
          "type": "basic.constant",
          "data": {
            "name": "CURSEL",
            "value": "1'b0",
        ...
        {
          "id": "a9841627-7e79-45e1-b101-d5086ce00565",
          "type": "basic.code",
          "data": {
            "code": "`define VS 1:1\nwire int_clk;\nreg [9:0] counter;\nassign int_clk = RGB[`VS];\nassign XC = counter;\nassign YC = {counter[9:4], 4'b0000};\n//-- 10 bit counter\nalways @(posedge int_clk)\n if (counter <638)\n  counter <= counter + 1;\n else\n  counter <=0;\n",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "1b98f881-9467-46ca-a275-f7ff60a16d70",
          "type": "a909bf57f2c0eb68d7ea1231b4b01feb6273c7e2",
          "position": {
            "x": 1368,
            "y": 80
          },
        ...
        {
          "id": "d9351562-e29b-4072-b93a-d4353fd57584",
          "type": "bcde6174932747fc38924511f5ed4f7391894eb9",
          "position": {
            "x": 1056,
            "y": 144
          },
        ...
        {
          "id": "917dc3bf-3ba4-4f28-b11a-c624bcb81906",
        ...
        {
          "id": "7bc0fb96-c065-49c7-9632-86cf8df364f9",
          "type": "6c407782d89d99b012a1614d20d8003bc63ed986",
          "position": {
            "x": 824,
            "y": 288
        ...
        {
          "id": "9ec29b83-0853-43ca-ac6c-b0a2985d56b6",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "9ec29b83-0853-43ca-ac6c-b0a2985d56b6",
            "port": "6e4ac81b-0abc-4441-a529-d2cb74e0a28c"
          },
          "target": {
            "block": "1b98f881-9467-46ca-a275-f7ff60a16d70",
            "port": "53d23702-bcff-4596-9137-d9d3616cc7d7"
          }
        },
        {
          "source": {
            "block": "a9841627-7e79-45e1-b101-d5086ce00565",
            "port": "XC"
          },
          "target": {
            "block": "1b98f881-9467-46ca-a275-f7ff60a16d70",
            "port": "827991b2-7229-45a9-9689-4799b3e2e19a"
          },
          "vertices": [
            {
              "x": 1280,
        ...
        },
        {
          ...
          "target": {
            "block": "1b98f881-9467-46ca-a275-f7ff60a16d70",
            "port": "5f4fab1a-c3e9-4f46-83be-edabfe8428f4"
          },
          "vertices": [
            {
              "x": 1584,
        ...
        {
          "source": {
            "block": "d9351562-e29b-4072-b93a-d4353fd57584",
        ...
        {
          "source": {
            "block": "917dc3bf-3ba4-4f28-b11a-c624bcb81906",
            "port": "10563024-bd0a-4a4d-856c-4bb1dff3f104"
          },
          "target": {
            "block": "d9351562-e29b-4072-b93a-d4353fd57584",
        ...
        },
        {
          ...
          "target": {
            "block": "7bc0fb96-c065-49c7-9632-86cf8df364f9",
            "port": "4ef4f2b1-023d-4569-8e10-643ef6cc71cb"
          }
        },
        {
        ...
        {
          "source": {
            "block": "4178e74d-6477-46c8-bb4f-17c6e372d757",
            "port": "constant-out"
          },
          "target": {
            "block": "1b98f881-9467-46ca-a275-f7ff60a16d70",
            "port": "25a9aad4-c1b6-4adf-87c1-b81244ba9f4a"
          }
        }
      ]
    },
  ...
  "dependencies": {
    ...
    "a909bf57f2c0eb68d7ea1231b4b01feb6273c7e2": {
      "package": {
        "name": "PxsCursor",
        "version": "0.1",
    ...
    "bcde6174932747fc38924511f5ed4f7391894eb9": {
      "package": {
        "name": "PxsMux2",
        "version": "1.0",

{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3fef24cf-0d23-4910-93fe-83ef4641c1a9",
        ...
        {
          "id": "93089922-2059-4bd4-b74a-e50a78e03d32",
          "type": "c4fc8961c909379e3599eee4a67d4046967e23ea",
          "position": {
            "x": 872,
            "y": 24
          },
        ...
        {
          "id": "86a25932-2a9f-401c-b0cc-7ba0c1354303",
      ...
      "wires": [
        {
          "source": {
            "block": "86a25932-2a9f-401c-b0cc-7ba0c1354303",
        ...
        {
          "source": {
            "block": "3fef24cf-0d23-4910-93fe-83ef4641c1a9",
        ...
        },
        {
          ...
          "target": {
            "block": "93089922-2059-4bd4-b74a-e50a78e03d32",
  ...
  "dependencies": {
    ...
    "c4fc8961c909379e3599eee4a67d4046967e23ea": {
      "package": {
        "name": "PxsPoPSprite",
        "version": "0.1",
        "description": "PoP sprites sequence",
        "author": "Sergio Cuenca",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20xmlns:xlink=%22http://www.w3.org/1999/xlink%22%20width=%2232%22%20height=%2240%22%20viewBox=%220%200%2032%2040%22%3E%3Cimage%20width=%2232%22%20height=%2240%22%20preserveAspectRatio=%22none%22%20xlink:href=%22data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAoCAYAAACfKfiZAAAABHNCSVQICAgIfAhkiAAAAddJREFU%20WIXFl7txwzAMhqFcFlARjWCXXsGFVwBHyBQqtUQygrCCC6+g0hlBKTRCUujFB/gQRCW48+mO4hEf%20foCAXHw8+x/4R3v1vbifK2ft9uyzA7z4nCMCIMah9hqrwO3ZA3arM6LsfhdjFdCdckocDlDWleH0%20zwGGxiw2ouMgoimwn7mtiPWBsp6KEdt1kZSj0mEA93MF2LaAcw6oGB/kpkpi3hTMhq0eebGuo6bO%20kQCjszF6gtZa3w+RBKCD5IYwAMq6cg4jpZIgpLYUod18ZlMKzCKcwZb7qQBRXpRsCojWH6KrAgA4%20QFIVlmE0ND3QJL8dya0ZI7ad5jBDgaHpvTIOl6uzpgNJO+WmW2AbqWKRXtqUNgHMhUdEU0pEPuUA%20w+W6Vn8m834T+szMexvYeQBA2T0ATiuADvP59S0CSE5B2T2815CIRrgjAULOQ++zALyf3pKcS1SI%20AnCHEhGbc4kK8Q8SZgjNXZHrjltVCAJwh3FOdduqwq5WDMA3py0qBAFi0fr2IWIyRFSB1OjsfakQ%20UQAuOt8+CURSDegHh4aRb1iFIKJ/TPRDENG4hrH9PkjdkofR1lGsOwopILqG0sGzCyCHUy510RTk%20jJazKEBqM5Ke8wte3+EuXWnpjgAAAABJRU5ErkJggg==%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            ...
            },
            {
              ...
              "type": "basic.code",
              "data": {
                "code": "// @include Pxs.vh\r\n// @include PxsPoPSprite.v\r\n\r\n\r\nPxsPoPSprite #(.FILE_sprite(SPRITE))\r\nPxsPoPSprite1(\r\n    px_clk,\r\n    RGBStr_i,\r\n    RGBStr_o\r\n    );\r\n",
                "params": [
                  {
                    "name": "SPRITE"
                  }
